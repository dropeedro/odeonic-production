...
async def create_checkout_session(request: CreateCheckoutSessionRequest):
    try:
        ...
        success_url = f"https://great-raccoon-adequately.ngrok-free.app/success?song_id={request.song_id}"
        cancel_url = "https://great-raccoon-adequately.ngrok-free.app/cancel"
