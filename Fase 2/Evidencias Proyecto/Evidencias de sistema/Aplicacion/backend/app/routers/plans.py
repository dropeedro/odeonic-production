...
async def create_subscription_session(request: SubscriptionRequest):
    ...
    try:
        ...
        session = stripe.checkout.Session.create(
            ...
            success_url=f"https://great-raccoon-adequately.ngrok-free.app//user?success=true&email={request.email}&plan={request.plan_id}",
            cancel_url="https://great-raccoon-adequately.ngrok-free.app//dashboard?canceled=true",
