...
const keycloak = new Keycloak({
  ...
  redirectUri: "https://great-raccoon-adequately.ngrok-free.app"
});
      ...
      if (authenticated) {
        ...
        if (currentPath === '/' || currentPath === '/index.html') {
          ...
          if (roles.includes('uma_authorization')) {
            ...
            window.location.href = 'https://great-raccoon-adequately.ngrok-free.app/admin';
          } else {
            // Redirige a la ruta del usuario normal
            // window.location.href = 'http://localhost:5173/user';
            window.location.href = 'https://great-raccoon-adequately.ngrok-free.app/user';
          }
        }
